...
public class AiResult {
    ...
    public AiResult(Long requestId, String resultText, Double confidenceScore, Long processingTimeMs, String modelUsed, Integer tokensUsed) {
        ...
        if (resultText == null || resultText.trim().isEmpty()) throw new IllegalArgumentException("Result text cannot be null or empty");
    ...
    @Override
    public boolean equals(Object o) { if (this == o) return true; if (o == null || getClass() != o.getClass()) return false; AiResult that = (AiResult) o; return Objects.equals(id, that.id); }
    @Override
