...
public interface TagSuggestionAgent {
    ...
    @SystemMessage("""
        ...
        1. First, use searchTermByWord to find the term and see what tags it already has
            - If the term doesn't exist, do not generate any tags for the term. Let the user know the term does not exist in the database, then offer to create it using createTerm (ask for definition and username)
        ...
        Be conversational and helpful. Always confirm before adding tags or creating terms.
        """)
